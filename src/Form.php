...
use Kizi\Admin\Exception\Handle;
use Kizi\Admin\Form\Builder;
use Kizi\Admin\Form\Field;
use Kizi\Admin\Form\Field\File;
use Kizi\Admin\Form\Tab;
...
class Form
{
    ...
    {
        $map = [
            'button'         => \Kizi\Admin\Form\Field\Button::class,
            'checkbox'       => \Kizi\Admin\Form\Field\Checkbox::class,
            'color'          => \Kizi\Admin\Form\Field\Color::class,
            'currency'       => \Kizi\Admin\Form\Field\Currency::class,
            'date'           => \Kizi\Admin\Form\Field\Date::class,
            'dateRange'      => \Kizi\Admin\Form\Field\DateRange::class,
            'datetime'       => \Kizi\Admin\Form\Field\Datetime::class,
            'dateTimeRange'  => \Kizi\Admin\Form\Field\DatetimeRange::class,
            'datetimeRange'  => \Kizi\Admin\Form\Field\DatetimeRange::class,
            'decimal'        => \Kizi\Admin\Form\Field\Decimal::class,
            'display'        => \Kizi\Admin\Form\Field\Display::class,
            'divider'        => \Kizi\Admin\Form\Field\Divide::class,
            'divide'         => \Kizi\Admin\Form\Field\Divide::class,
            'embeds'         => \Kizi\Admin\Form\Field\Embeds::class,
            'editor'         => \Kizi\Admin\Form\Field\Editor::class,
            'email'          => \Kizi\Admin\Form\Field\Email::class,
            'file'           => \Kizi\Admin\Form\Field\File::class,
            'hasMany'        => \Kizi\Admin\Form\Field\HasMany::class,
            'hidden'         => \Kizi\Admin\Form\Field\Hidden::class,
            'id'             => \Kizi\Admin\Form\Field\Id::class,
            'image'          => \Kizi\Admin\Form\Field\Image::class,
            'ip'             => \Kizi\Admin\Form\Field\Ip::class,
            'map'            => \Kizi\Admin\Form\Field\Map::class,
            'mobile'         => \Kizi\Admin\Form\Field\Mobile::class,
            'month'          => \Kizi\Admin\Form\Field\Month::class,
            'multipleSelect' => \Kizi\Admin\Form\Field\MultipleSelect::class,
            'number'         => \Kizi\Admin\Form\Field\Number::class,
            'password'       => \Kizi\Admin\Form\Field\Password::class,
            'radio'          => \Kizi\Admin\Form\Field\Radio::class,
            'rate'           => \Kizi\Admin\Form\Field\Rate::class,
            'select'         => \Kizi\Admin\Form\Field\Select::class,
            'slider'         => \Kizi\Admin\Form\Field\Slider::class,
            'switch'         => \Kizi\Admin\Form\Field\SwitchField::class,
            'text'           => \Kizi\Admin\Form\Field\Text::class,
            'textarea'       => \Kizi\Admin\Form\Field\Textarea::class,
            'time'           => \Kizi\Admin\Form\Field\Time::class,
            'timeRange'      => \Kizi\Admin\Form\Field\TimeRange::class,
            'url'            => \Kizi\Admin\Form\Field\Url::class,
            'year'           => \Kizi\Admin\Form\Field\Year::class,
            'html'           => \Kizi\Admin\Form\Field\Html::class,
            'tags'           => \Kizi\Admin\Form\Field\Tags::class,
            'icon'           => \Kizi\Admin\Form\Field\Icon::class,
            'multipleFile'   => \Kizi\Admin\Form\Field\MultipleFile::class,
            'multipleImage'  => \Kizi\Admin\Form\Field\MultipleImage::class,
            'captcha'        => \Kizi\Admin\Form\Field\Captcha::class,
        ];
