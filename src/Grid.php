...
use Kizi\Admin\Grid\Column;
use Kizi\Admin\Grid\Displayers\Actions;
use Kizi\Admin\Grid\Displayers\RowSelector;
use Kizi\Admin\Grid\Exporter;
use Kizi\Admin\Grid\Filter;
use Kizi\Admin\Grid\Model;
use Kizi\Admin\Grid\Row;
use Kizi\Admin\Grid\Tools;
...
class Grid
{
    ...
    public function resource($path = null)
    {
        ...
        // dd(app('router')->current()->getPath());
        return url(app('router')->current()->getPath());
    }
    ...
    {
        $map = [
            'editable'    => \Kizi\Admin\Grid\Displayers\Editable::class,
            'switch'      => \Kizi\Admin\Grid\Displayers\SwitchDisplay::class,
            'switchGroup' => \Kizi\Admin\Grid\Displayers\SwitchGroup::class,
            'select'      => \Kizi\Admin\Grid\Displayers\Select::class,
            'image'       => \Kizi\Admin\Grid\Displayers\Image::class,
            'label'       => \Kizi\Admin\Grid\Displayers\Label::class,
            'button'      => \Kizi\Admin\Grid\Displayers\Button::class,
            'link'        => \Kizi\Admin\Grid\Displayers\Link::class,
            'badge'       => \Kizi\Admin\Grid\Displayers\Badge::class,
            'progressBar' => \Kizi\Admin\Grid\Displayers\ProgressBar::class,
            'radio'       => \Kizi\Admin\Grid\Displayers\Radio::class,
            'checkbox'    => \Kizi\Admin\Grid\Displayers\Checkbox::class,
            'orderable'   => \Kizi\Admin\Grid\Displayers\Orderable::class,
        ];
